...
function ifs() {
  if (player.isTouching(carro1)) {
    player.x = 70;
    player.y = 200;
    MORTES += 1;
  }
  if (player.isTouching(carro2)) {
    player.x = 70;
    player.y = 200;
    MORTES += 1;
  }
  if (player.isTouching(carro3)) {
    player.x = 70;
    player.y = 200;
    MORTES += 1;
  }
  if (player.isTouching(carro4)) {
    player.x = 70;
    player.y = 200;
    MORTES += 1;
  }
...
function colições() {
  ...
  carro1.bounceOff(parede3);
  carro1.bounceOff(parede4);
  
  carro2.bounceOff(parede1);
  carro2.bounceOff(parede2);
  carro2.bounceOff(parede3);
  carro2.bounceOff(parede4);
  
  carro3.bounceOff(parede1);
  carro3.bounceOff(parede2);
  carro3.bounceOff(parede3);
  carro3.bounceOff(parede4);
  
  carro4.bounceOff(parede1);
carro4.bounceOff(parede2);
carro4.bounceOff(parede3);
carro4.bounceOff(parede4);
}
